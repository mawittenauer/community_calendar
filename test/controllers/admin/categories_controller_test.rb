...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_category" do
    assert_difference("Admin::Category.count") do
      post admin_categories_url, params: { admin_category: { description: @admin_category.description, is_active: @admin_category.is_active, name: @admin_category.name, slug: @admin_category.slug, sort_order: @admin_category.sort_order } }
    end
  ...
  test "should update admin_category" do
    patch admin_category_url(@admin_category), params: { admin_category: { description: @admin_category.description, is_active: @admin_category.is_active, name: @admin_category.name, slug: @admin_category.slug, sort_order: @admin_category.sort_order } }
